...
Route::get('/fetch/main/pestcatagory', 'CommondataController@getMainPestcatagory');
...
Route::get('/fetch/pestcontrollmethods', 'CommondataController@getPestcontrollmethods');
